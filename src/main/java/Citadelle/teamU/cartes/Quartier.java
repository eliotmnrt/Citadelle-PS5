...
public enum Quartier implements Comparable<Quartier> {
    ...
    CIMETIERE("cimitière",5,TypeQuartier.VIOLET, 1),BIBLIOTHEQUE("bibliothèque",6,TypeQuartier.VIOLET, 1),ECOLE_DE_MAGIE("école de magie",6,TypeQuartier.VIOLET, 1),UNIVERSITE("université",6,TypeQuartier.VIOLET, 1),DRACOPORT("dragoport",6,TypeQuartier.VIOLET, 1);
