...
public enum Quartier implements Comparable<Quartier> {
    ...
    CIMETIERE("cimère",5,TypeQuartier.VIOLET, 1),BIBLIOTHEQUE("bibliothèque",6,TypeQuartier.VIOLET, 1),ECOLE_DE_MAGIE("école de magie",6,TypeQuartier.VIOLET, 1),UNIVERSITE("université",6,TypeQuartier.VIOLET, 1),DRAGOPORT("dragoport",6,TypeQuartier.VIOLET, 1);
